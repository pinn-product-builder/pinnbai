/**
 * Página de Login do MicroSaaS
 * Tela inicial com funil de login
 */
...
export default function SaasLoginPage() {
  ...
  const { signIn, loading, isAuthenticated, isAfonsina, isAdmin } = useSaasAuth();
  ...
  useEffect(() => {
    if (isAuthenticated && !loading) {
      if (isAfonsina) {
        navigate('/dash/executivo', { replace: true });
      } else if (isAdmin) {
  ...
  }, [isAuthenticated, isAfonsina, isAdmin, loading, navigate]);
